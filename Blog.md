...
那为什么要分段呢？  
首先，我的任务是探究不同频率的刺激下不同组的被试在接收到刺激的脑电信号改变与差异。又不同频率的刺激是集中几秒给的，受频率的原因，将整块刺激block作为一个整体似乎更便于分析这段时间的刺激对被试的影响。  
...
不过问题不只在切哪一段，切多长也需要考量，抛开统计量本身不谈，尽量做到控制变量唯一也是应该的，特别是时候计算sample entropy，时长是得统一，毕竟是熵嘛，至于PSD都还好说。  
> 前者是3s的长度，后者控制大于2s。
